...
- **Video:** upload an MP4, WebM or MOV file. After the virus scan it shows "Preparing video…" while it is converted, then a **Play** button. The player switches quality automatically, or pick one from the Quality menu.
